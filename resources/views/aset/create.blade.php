...
@section('title', 'Tambah Aset - Inventory Pesantren')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('kode_aset') is-invalid @enderror"
                                    id="kode_aset" name="kode_aset" value="{{ old('kode_aset') }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                    ...
                                    placeholder="Masukkan deskripsi aset">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
